...
마케팅은 결국, 복잡한 선택의 순간마다 가장 적절한 판단을 내리는 기술이다. 고객을 누구로 정의할 것인지, 어떤 가치를 전달할 것인지, 어느 경로를 통해 연결할 것 인지를 끊임없이 결정해야 한다. 결국 \index{마케팅}마케팅이란, 수많은 가능성들 사이에서 하나의 방향을 선택하는 판단의 기술이자 구조의 예술이다.
