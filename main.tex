...
\usepackage{pdfpages} % Required for including cover PDF

\begin{document}
% Include Cover Page (Must be built first as build/cover.pdf)
\IfFileExists{build/cover.pdf}{
...
\publishers{지그재그\textsuperscript{**}\begingroup\renewcommand{\thefootnote}{**}\footnotetext{지식그래프 재미나게 그어보기}\endgroup}
